  ...
  created() {
    ...
    methods: {
      ...
      doSubmit() {
            ...
            // 判断内容有没有输入完整
            if(this.form.title===""||this.form.category===""||this.form.author===""||this.form.content===""||this.form.description===""||this.form.isShow===""||this.form.imgUrl===""||this.form.content==="<p><br></p>"){
               this.$message({
                  message: '内容没有输入完整',
                  type: 'warning'
               });
